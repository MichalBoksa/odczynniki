"use client";
import { COPPER_PRODUCTS_PL} from '@/constants';

const CooperInfo = () => {

return (
    <section className='padding-container'>
             <h1 className='text-8xl w-full mb-10'>Miedź </h1>
                    <div className='flex gap-12 w-full mb-20 mt-20'>
                            ...
                            <div className='flex-2 flex mt-10'>
                                    <p className='px-10 font-normal text-lg'>Pierwiastek chemiczny z grupy metali przejściowych w kolorze czerwonobrązowym. Jest odporna na korozję, wytrzymała, ciągliwa, skutecznie przewodzi prąd i ciepło, łatwo tworzy stopy. Miedź stosowany m.in. w rolnictwie, uzdatnianiu wody, paszach dla zwierząt ale również w pigmentach i ceramice, szkle, galwanizacji oraz  katalizatorach.</p>
                            </div>
                    </div>
                    ...
                    <div className='flex flex-col rounded border-solid border-2 border-base-200 max-container padding-container py-4 mb-4'>
                            ...
                            <div className='flex flex-col gap-10 mt-6'>
                                    {COPPER_PRODUCTS_PL.map((product,index) => (
                                            <div key={product.symbol} className={`flex gap-7 items-center justify-center ${index !== COPPER_PRODUCTS_PL.length - 1 ? 'border-b-2 border-b-gray-300' : ''}`} >
