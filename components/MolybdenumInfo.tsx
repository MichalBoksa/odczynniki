             ...
             <h1 className='text-8xl w-full mb-10'>{data?.MOLYBDENUM}</h1>
                    <div className='flex gap-12 mb-20 mt-20'>
                            ...
                            <div className='flex-2 flex mt-10'>
                                    <p className='px-10 font-normal text-lg'>{data?.MOLYBDENUM_DESC}</p>
                            </div>
                    </div>
                    ...
                    <div className='flex flex-col rounded border-solid border-2 border-base-200 max-container padding-container py-4 mb-4'>
                            ...
                            <div className='flex flex-col gap-10 mt-6 pb-3'>
                                    {data?.MOLYBDENUM_PRODUCTS.map((product,index) => (
                                            <div key={product.symbol} className={`flex gap-7 items-center justify-center ${index !== data?.MOLYBDENUM_PRODUCTS.length - 1 ? 'border-b-2 border-b-gray-300 pb-8' : ''}`} >
