...
const EuFunds = () => {
  ...
  return (
    <section className='max-container padding-container bg-secondary p-3'>
    <div className="flex flex-col justify-center mb-5 mt-10 " >
       ...
       <div className='flex flex-col lg:px-16 px-7 ml-5 mr-5 mb-10 bg-secondary rounded '>
       ...
       <div className='flex flex-col lg:px-16 px-7 ml-5 mr-5 mb-10 bg-secondary '>
