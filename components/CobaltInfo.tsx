...
const CobaltInfo = () => {
  ...
  return (
    <section className='max-container md:padding-container'>
      <h1 className='text-4xl md:text-6xl lg:text-8xl w-full mb-10 text-center'>{data?.COBALT}</h1>
      ...
      <div className='flex flex-col lg:flex-row gap-12 mb-20 mt-20 items-center'>
        ...
        <div className='flex flex-2 mt-10 lg:mt-0'>
          <p className='px-3 lg:px-10 font-normal text-lg text-center lg:text-left'>{data?.COBALT_DESC}</p>
        </div>
      </div>
