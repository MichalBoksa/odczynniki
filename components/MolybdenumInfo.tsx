...
return (
    <section className='padding-container max-container'>
             <h1 className='text-8xl w-full mb-10'>Molibden </h1>
                    <div className='flex mt-6 gap-12 w-full mb-10'>
                    ...
                    <div className='flex flex-col rounded border-solid border-2 border-base-200 max-container padding-container py-4 mb-4'>
                            ...
                            <div className='flex flex-col gap-10 mt-6'>
                                    {MOLYBDENUM_PRODUCTS_PL.map((product,index) => (
                                            <div key={product.symbol} className={`flex gap-7 items-center justify-center ${index !== MOLYBDENUM_PRODUCTS_PL.length - 1 ? 'border-b-2 border-b-secondary' : ''}`} >
                                                    ...
                                                    <div className='flex flex-1 flex-col mb-6'>
                                                            <h1 className='text-xl mb-2'>Zastosowanie</h1>
                                                            <div className='flex flex-col'>
