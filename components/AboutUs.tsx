...
<div className='flex max-container w-full max-w-[60%] max-h-[700px] '>
       ...
       <div className='flex flex-col '>
           <div className="flex mb-8 mt-8 lg:px-16 text-center text-cream " >
   ...
   <div className='flex flex-col md:flex-row bg-dark-gray text-cream max-container w-full lg:min-h-[250px] tracking-wid p-3'>
       ...
       <div className='flex flex-col w-[60%] items-start justify-center'>     
        ...
        <div className=' flex flex-col w-[40%] lg:px-8 items-center justify-center' >
            <h6 className="text-4xl">{data?.REGISTRATION_DETAILS}</h6> 
       </div>
   </div>
